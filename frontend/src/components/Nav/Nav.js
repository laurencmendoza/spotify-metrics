...
export default function Nav() {
    return (
        ...
        <nav className="flex sm:flex-col sm:justify-start justify-between">
            ...
            <Link className="sm:mt-[100px] sm:mb-10 sm:pl-4 font-bold text-[1.25rem]" to="/">
                Home
            </Link>
            <Link className="sm:my-10 sm:px-4 font-bold text-[1.25rem]" to="/playlists">
                Playlists
            </Link>
            <Link className="sm:my-10 sm:px-4 font-bold text-[1.25rem] mr-4" to="/metrics/medium_term">
                Metrics
            </Link>
        </nav>
