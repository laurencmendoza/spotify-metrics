            ...
            {playlists.items.map((i, idx)=>(
                <div className="playlist">
                    <Link to={`/playlists/${i.id}`}>
                        ...
                        ) : (<img className="playlist-img bg-white-smoke" src="https://cdnweb.anghami.com/web/assets/img/placeholders/playlist-placeholder.png" height="200" width="200" alt="playlist cover placeholder"/>)}
                    </Link>
